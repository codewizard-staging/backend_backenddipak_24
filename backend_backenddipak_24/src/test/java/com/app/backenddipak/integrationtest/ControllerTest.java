package com.app.backenddipak.integrationtest;
...
import com.app.backenddipak.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("backenddipak", n.getAttribute("Namespace"));
  ...
  void  testCreateOrganizationInstance() throws IOException {
    given()
        ...
        .when()
        .post("/backenddipak/Organizations")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/backenddipak/Organizations?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/backenddipak/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/backenddipak/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/backenddipak/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/backenddipak/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/backenddipak/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/backenddipak/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/backenddipak/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM backenddipak.Organization");
    jdbcTemplate.execute("DELETE FROM backenddipak.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM backenddipak.EmlpoyeeProfile");
